    ...
    return (
        <div className="min-h-screen flex flex-col items-center bg-white py-16">
            <div className="w-[1135px] bg-[#F6F6F6] rounded-[30px] px-20 py-12 flex flex-col">
                <h1 className="mb-8 text-[#22324A] text-[38px] font-semibold text-left">
                ...
                <h1 className="text-[#22324A] text-[38px] font-[500] text-left text-gotham">
                    What is a Business Immigrant Visa (C5)?
                </h1>

                {/* Описание */}
                <p className="mt-1 text-[#000000] text-gotham text-[20px] leading-[25px] max-w-[1000px]">
                ...
                <div className="mt-10 flex justify-between gap-6">
                    ...
                    <div className="bg-white w-[310px] h-[300px] rounded-[20px] p-6 flex flex-col items-start">
                        ...
                        />
                        <h3 className="text-[#22324A] text-[30px] text-gotham font-[500]">Purpose</h3>
                    ...
                    <div className="bg-white w-[310px] h-[300px] rounded-[20px] p-6 flex flex-col items-start">
                        <img
                            ...
                            className="w-[50px] h-[50px] mb-4"
                        />
                        <h3 className="text-[#22324A] text-[30px] text-gotham font-[500]">Validity</h3>
                        <p className="text-[#22324A] text-[20px] font-normal leading-tight">
                    ...
                    <div className="bg-white w-[310px] h-[300px] rounded-[20px] p-6 flex flex-col items-start">
                        <img
                            ...
                            className="w-[50px] h-[50px] mb-4"
                        />
                        <h3 className="text-[#22324A] text-[30px] text-gotham font-[500]">Stay duration</h3>
                        <p className="text-[#22324A] text-[20px] font-normal leading-tight">
                ...
                <div className="mt-10 flex gap-6">
                    ...
                    <div className="bg-white w-[310px] h-[300px] rounded-[20px] p-6 flex flex-col items-start">
                        ...
                        />
                        <h3 className="text-[#22324A] text-[30px] text-gotham font-[500]">
                            Residence Permit
                        </h3>
                        <p className="text-[#22324A] text-[20px] text-gotham leading-tight">
                    ...
                    <div className="bg-white w-[310px] h-[300px] rounded-[20px] p-6 flex flex-col items-start">
                        <img
                            ...
                            className="w-[50px] h-[50px] mb-4 scale-125"
                        />
                        <h3 className="text-[#22324A] text-[30px] text-gotham font-[500] leading-none">
                            Investment requirement
                        </h3>
                        <p className="text-[#22324A] text-[20px] text-gotham leading-tight mt-2">
                ...
                <p className="mt-5 text-[20px] font-[400] font-gotham tracking-[-0.03em]">You need a C5 visa if you plan to:</p>
                <div className="flex flex-col gap-4 mt-5">
                    <div className="flex items-center gap-3">
                        <img src={docPng} alt="icon" className="w-12 h-12 mt-1" />
                        <p className="text-[20px] font-[400] text-gotham">
                ...
                <h1 className="mt-10 text-[#22324A] text-[38px] text-gotham text-left font-[500]">
                ...
                <div className="mt-12 w-[975px] bg-white rounded-[20px] mx-auto flex flex-col px-10 py-8">
                    <h1 className="text-[#22324A] text-[38px] text-gotham text-left font-[500] mb-4">
