...
export default function QuestionnaireForm() {
  ...
  return (
    <form className="max-w-3xl mx-auto p-6 space-y-6 text-gotham text-[#22324A]  bg-[#FFFFFF] md:bg-[#F6F6F6] rounded-[30px] my-8">
      ...
      <div>
        ...
        >
          ...
          {form.document && (
            <div className="mt-4 bg-white p-3 rounded-xl shadow-sm border flex items-center justify-center gap-2">
