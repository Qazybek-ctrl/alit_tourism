        ...
        <footer className="w-full bg-[#F6F6F6]">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 px-8 py-10 text-[#0A142F] text-left">
                ...
                <div>
                    ...
                    <ul className="flex flex-col gap-2 text-[13px]">
                        <li><a href="#" className="hover:underline opacity-70">Lift Tickets</a></li>
                        <li><a href="#" className="hover:underline opacity-70">Season Passes</a></li>
                ...
                <div className="min-w-[230px]">
                    ...
                    <ul className="flex flex-col gap-2 text-[13px]">
                        <li className="flex gap-3">
                            <span className="opacity-70">Hotel Reservation:</span>
                            <span className="font-semibold">+7 (701) 123-45-67</span>
                        </li>
                        <li className="flex gap-3">
                            <span className="opacity-70">Ticket Office:</span>
                            <span className="font-semibold">+7 (701) 123-45-67</span>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div className="flex gap-4 items-center">
                        <img src={instagramIcon} alt="Instagram" className="w-5 h-5 cursor-pointer hover:opacity-70" />
                        <img src={facebookIcon} alt="Facebook" className="w-5 h-5 cursor-pointer hover:opacity-70" />
                        <img src={youtubeIcon} alt="YouTube" className="w-5 h-5 cursor-pointer hover:opacity-70" />
                        <img src={twitterIcon} alt="Twitter" className="w-5 h-5 cursor-pointer hover:opacity-70" />
                    </div>
                </div>
            </div>
